...
if XA_CABIN_PLANE_CONFIG.LANDING_LIGHTS ~= nil then
    XA_CABIN_PLANE_CONFIG["LANGING_LIGHTS"] = {}
    XA_CABIN_PLANE_CONFIG["LANGING_LIGHTS"] = XA_CABIN_PLANE_CONFIG.LANDING_LIGHTS
    XA_CABIN_PLANE_CONFIG.LANDING_LIGHTS = nil
